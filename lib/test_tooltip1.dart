...
List<WeatherData> getWeatherData() {
  final List<WeatherData> weatherData = [
    ...
    WeatherData('Sunday', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Mon 2', 23.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Tue 2', 25.9, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Wed 2', 30.1, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Thu 2', 27.5, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Fri 2', 21.3, 'Rainy',
        'assets/google_weather_icons/v4/rain.svg'),
    WeatherData('Sat 2', 22.0, 'Cloudy',
        'assets/google_weather_icons/v4/cloudy.svg'),
    WeatherData('Sun 2', 28.8, 'Partly Cloudy',
        'assets/google_weather_icons/v4/partly_cloudy_day.svg'),
    WeatherData('Mon 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Tue 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Wed 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Thu 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Fri 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Sat 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
    WeatherData('Sun 3', 29.4, 'Sunny',
        'assets/google_weather_icons/v4/clear_day.svg'),
  ];
  return weatherData;
}
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    // --- IMPROVEMENT: Updated text to guide the user ---
                    Text(
                    ...
                    // --- MODIFICATION: Added horizontal scrolling for the chart ---
