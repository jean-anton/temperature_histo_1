...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1533: (o, p) => p in o,
      _1534: (o, p) => o[p],
      _1555: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1556: (x0,x1) => globalThis.fetch(x0,x1),
      _1557: (x0,x1) => x0.get(x1),
      _1558: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1558(f,arguments.length,x0,x1,x2) }),
      _1559: (x0,x1) => x0.forEach(x1),
      _1560: x0 => x0.abort(),
      _1561: () => new AbortController(),
      _1562: x0 => x0.getReader(),
      _1563: x0 => x0.read(),
      _1564: x0 => x0.cancel(),
      _1565: (x0,x1) => x0.key(x1),
      _1566: x0 => x0.random(),
